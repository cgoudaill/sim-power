...
const SOCIAL_LINKS = [
  {
    href: "https://www.facebook.com/thesimpower",
    label: "Facebook",
    icon: (
  ...
  {
    href: "https://www.tiktok.com/@thesimpower",
    label: "TikTok",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    href: "https://www.instagram.com/thesimpower",
    label: "Instagram",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center gap-3 mt-6">
              {SOCIAL_LINKS.map((social) => (
                <a
                  ...
                  className="p-2.5 bg-white/5 rounded-full text-muted hover:text-accent hover:bg-accent/10 transition-all duration-200"
                >
                  {social.icon}
                </a>
              ))}
